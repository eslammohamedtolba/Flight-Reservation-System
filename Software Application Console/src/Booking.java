...
public class Booking {
    ...
    public void printBookings(){
        try {
            ...
            while (rs.next()) {
                Ar.add("passenger_ssn "+rs.getInt("passenger_ssn"));
                Ar.add("booking date "+rs.getTimestamp("Booking_Date").toLocalDateTime());
                Ar.add("total price "+rs.getFloat("Total_price"));
                Ar.add("tickets number "+rs.getInt("Tickets_Num"));
    ...
    public boolean ExistBooking(int id){
        try {
