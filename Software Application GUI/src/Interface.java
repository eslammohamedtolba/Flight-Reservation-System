    ...
    public void AdminMenu(){
        ...
        Admin:while(true){
            System.out.println("(1) Adding an aircraft\n"+
                               ...
                               "(8) print Bookings Number for each passenger\n" +
                               "(9) print tickets Number for each Flight\n" +
                               "(10) Select Max and Min Booking Prices\n" +
                               "(11) return to last Menu");
            choice=in.nextInt();
            if(choice==1){
                ...
                new Passenger().BookingsForPassengers();
            }
            else if(choice==9){
                new Passenger().BookingsForPassengers();
            }
            else if(choice==10){
                ArrayList A=new Booking().MinMaxPriceForBookings();
            }
            else if(choice==11){
                Display();
                break Admin;
